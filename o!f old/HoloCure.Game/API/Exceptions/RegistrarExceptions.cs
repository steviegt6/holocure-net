...
namespace HoloCure.Game.API.Exceptions
{
    ...
    public class ImmutableRegistrarException : Exception
    {
        ...
        public ImmutableRegistrarException(string message)
            : base(message)
        {
        }

        public ImmutableRegistrarException(string message, Exception inner)
            : base(message, inner)
        {
        }
    ...
    public class RegistrarDuplicateKeyException : Exception
    {
        ...
        public RegistrarDuplicateKeyException(string message)
            : base(message)
        {
        }

        public RegistrarDuplicateKeyException(string message, Exception inner)
            : base(message, inner)
        {
        }
