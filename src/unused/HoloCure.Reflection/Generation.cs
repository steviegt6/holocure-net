...
using HoloCure.Reflection.Exceptions;
...
namespace HoloCure.Reflection
{
    public static class Generation
    {
        ...
        public static object? InvokeFieldGetter(Type type, string fieldName, object? instance) {
            ...
            if (getter is not null) {
                if (instance is null) throw new GeneratedMethodInvocationException("Attempted to get value of instanced field w/o instance.");

                return getter(instance);
            }

            if (staticGetter is not null) {
                if (instance is not null) throw new GeneratedMethodInvocationException("Attempted to get value of static field w/ instance.");

                return staticGetter();
            }

            throw new GeneratedMethodInvocationException(
        ...
        public static void InvokeFieldSetter(Type type, string fieldName, object? instance, object? value) {
            ...
            if (setter is not null) {
                if (instance is null) throw new GeneratedMethodInvocationException("Attempted to set value of instanced field w/o instance.");
            ...
            if (staticSetter is not null) {
                if (instance is not null) throw new GeneratedMethodInvocationException("Attempted to set value of static field w/ instance.");
        ...
        public static object? InvokePropertyGetter(Type type, string propertyName, object? instance) {
            ...
            if (getter is not null) {
                if (instance is null) throw new GeneratedMethodInvocationException("Attempted to get value of instanced property w/o instance.");

                return getter(instance);
            }

            if (staticGetter is not null) {
                if (instance is not null) throw new GeneratedMethodInvocationException("Attempted to get value of static property w/ instance.");
        ...
        public static void InvokePropertySetter(Type type, string propertyName, object? instance, object? value) {
            ...
            if (setter is not null) {
                if (instance is null) throw new GeneratedMethodInvocationException("Attempted to set value of instanced property w/o instance.");
            ...
            if (staticSetter is not null) {
                if (instance is not null) throw new GeneratedMethodInvocationException("Attempted to set value of static property w/ instance.");
    ...
    public static class Generation<T>
    {
        public static object? InvokeFieldGetter(string fieldName, object? instance) {
            return Generation.InvokeFieldGetter(typeof(T), fieldName, instance);
        }

        public static void InvokeFieldSetter(string fieldName, object? instance, object? value) {
            Generation.InvokeFieldSetter(typeof(T), fieldName, instance, value);
        }

        public static object? InvokePropertyGetter(string fieldName, object? instance) {
            return Generation.InvokePropertyGetter(typeof(T), fieldName, instance);
        }

        public static void InvokePropertySetter(string fieldName, object? instance, object? value) {
            Generation.InvokePropertySetter(typeof(T), fieldName, instance, value);
        }
    }
}